...
declare var $:any;
@Component({
  selector: 'app-extention-right',
  templateUrl: './extention-right.component.html',
  styleUrls: ['./extention-right.component.css']
})
export class ExtentionRightComponent implements OnInit {
